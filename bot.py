...
def start_cmd(update, context):
    update.message.reply_text(f"Hello {update.message.from_user.first_name}.\n\nI can upload photos from telegram to telegra.ph 🤫 Now send me a image.")
...
def upload(update, context):
    ...
    if mime not in ["jpg", "peg", "png", "gif", "mp4"]:
        return update.message.reply_text("Sorry.. This type of file is not supported by telegra.ph. Send me another image.")
